...
extern void CPlotPane_ZoomSubPlotInFocus(double zoom, bool in /*or out*/, bool horizontal);
extern void CPlotPane_ResizeSubPlotInFocus(double zoom, bool in /*or out*/);
