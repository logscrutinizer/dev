...
public:
    ...
    CTextParser() { m_text_p = nullptr; m_textLength = 0; m_parseIndex = 0; m_isSearchMatch = false; m_searchMatch_StartIndex = 0; m_searchMatch_EndIndex = 0; }
    ...
    bool Search(const char* match_p, unsigned int matchLength, int limitSearchOffset = -1);
